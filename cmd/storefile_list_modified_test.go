...
// not when the plan document is edited — `plan file list <feature>` lists
// the documents themselves for that.
func TestStoreFileList_CarriesModifiedAtPerEntry(t *testing.T) {
	...
	require.Equal(t, "plan", planDocs.Files[0]["name"])
}
