...
- [x] **Every task has a permanent identifier**
...
- [x] **Dependencies are readable in the plan**
...
- [x] **Exported tasks carry the full task picture**
...
- [x] **Repository location is never guessed**
...
- [x] **Completion and criteria are reported separately**
...
- [x] **Task runs use the whole plan's context**
...
- [x] **Task runs refuse tasks that cannot start**
...
- [x] **Feature-level wrap-up happens once**
...
- [x] **Public documentation covers the feature**
...
- [x] **Authored plans are made of tasks**
...
- [x] **Identifiers come from Spektacular**
...
- [x] **Identifier source is configurable**
...
- [x] **Human tasks are named in review**
...
- [x] **Invalid structure is refused on save**
...
- [x] **Export produces the task graph**
...
- [x] **Per-task progress in plan status**
...
- [x] **Wrap-up only on the last task**
...
- [x] **Old plans fail clearly for task features**
