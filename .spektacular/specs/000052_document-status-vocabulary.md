...
- [ ] **Closed date is stamped on closing**
...
- [ ] **Closed date survives a blank status**
...
- [ ] **Agent-facing guidance uses the new vocabulary**
...
- [ ] **Documentation uses the new vocabulary**
...
- [ ] **New artifact is written as draft**
...
- [ ] **Each of the four values is accepted**
...
- [ ] **Retired and invalid CLI values are rejected**
...
- [ ] **Unrecognised value reads as blank**
...
- [ ] **Rewrite drops the legacy field and keeps blank**
...
- [ ] **Blank artifact is filtered as neither draft nor final**
...
- [ ] **Blank to final keeps the original closed date**
...
- [ ] **Agent guidance and docs are updated**
